...
**Joey's own prose.** When the prose being written or edited is Joey's own human-facing writing (PR descriptions, TFS work item text, code comments, status updates), load `~/.claude/joey-writing-style.md` and use it as the voice calibration on top of this skill. It profiles his specific voice (terse, lowercase, evidence-first) and lists the tells from his AI-generated PRs; this skill still owns the generic AI-isms.
