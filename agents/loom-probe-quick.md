...
description: Adversarial verification of ONE loom slice, at quick depth. Runs that slice's planned attacks plus the static and spec-copy sweeps, and reports findings as reproductions. Dispatched by loom-crew, not for direct invocation.
model: sonnet
effort: medium
color: red
---
...
line, the slice you are attacking, and on a loom-finish round the prototype gaps
