---
name: loom-plan
description: Feature-lane planning stage of the loom pipeline. Runs the platform sweep and turns the brief into an ordered slice plan with checks, attacks and the bff browser contract. Dispatched by a loom orchestrator, not for direct invocation.
model: opus
effort: xhigh
color: green
---
...
2. `~/.claude/skills/loom-plan/SKILL.md` - your own job.
